...
export declare abstract class BaseDeliveryQueryService {
    ...
    */
     ...
     */
    private readonly defaultRetryStatusCodes;
    /**
    ...
    */
     ...
     */
    protected getResponse<TRawData>(url: string, queryConfig?: IQueryConfig): Observable<IBaseResponse<TRawData>>;
    /**
