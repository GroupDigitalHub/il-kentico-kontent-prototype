...
export declare type HttpRequestMethod = 'get' | 'GET' | 'delete' | 'DELETE' | 'head' | 'HEAD' | 'options' | 'OPTIONS' | 'post' | 'POST' | 'put' | 'PUT' | 'patch' | 'PATCH';
...
export declare class IHttpRequestResult<TResponse> {
    ...
    error?: any;
    constructor(response?: TResponse | undefined, error?: any);
}
