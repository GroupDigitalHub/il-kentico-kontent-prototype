...
import LifeInsurancePage from './Pages/LifeInsurance';
    ...
    return (
      <div className={`${classes.root} application-content`}>
        ...
        <Switch>
          ...
          />
          <Route
            path="/:lang?/lifeInsurance"
            render={matchProps => (
              <LifeInsurancePage {...matchProps} language={language} />
            )}
          />
          <Route
            path="*"
